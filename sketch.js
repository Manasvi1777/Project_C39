...
var gameOverImg,restartImg,youWinImg,win;
...
function setup() {
  ...
  trex = createSprite(camera.x,530,20,50);
  ...
  restart = createSprite(300,370);
  restart.addImage(restartImg);

  win = createSprite(300,370);
